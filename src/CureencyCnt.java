public class CureencyCnt {
    public static void main(String[] args) {
        ...
        System.out.printf("50000원 몫: %d개 나머지: %d \n", refund/curr50000,refund%curr50000);
        refund %= curr50000;
        System.out.printf("10000원 몫: %d개 나머지: %d \n", refund/curr10000,refund%curr10000);
        refund %= curr10000;
        System.out.printf("5000원 몫: %d개 나머지: %d \n", refund/curr5000,refund%curr5000);
        refund %= curr5000;
        System.out.printf("1000원 몫: %d개 나머지: %d \n", refund/curr1000,refund%curr1000);
        refund %= curr1000;
        System.out.printf("500원 몫: %d개 나머지: %d \n", refund/curr500,refund%curr500);
        refund %= curr500;
        System.out.printf("100원 몫: %d개 나머지: %d \n", refund/curr100,refund%curr100);
        refund %= curr100;

        System.out.printf("50원 몫: %d개 나머지: %d \n", refund/curr50,refund%curr50);
        refund %= curr50;
        System.out.printf("10원 몫: %d개 나머지: %d \n", refund/curr10,refund%curr10);
        refund %= curr10;
    }
}
